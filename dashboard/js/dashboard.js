...
function logoutOwner() {
  if (typeof lockConsole === 'function') {
    lockConsole();
  } else {
    sessionStorage.removeItem('feranoz_owner_auth_token');
    localStorage.removeItem('feranoz_owner_auth_token');
...
function renderOwnerMenuCatTabs() {
  ...
  enableOwnerTabsMouseSwipe(container);
}

function enableOwnerTabsMouseSwipe(bar) {
